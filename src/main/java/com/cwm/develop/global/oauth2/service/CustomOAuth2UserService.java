package com.cwm.develop.global.oauth2.service;

import com.cwm.develop.global.oauth2.CustomOAuth2User;
import com.cwm.develop.global.oauth2.OAuthAttributes;
...
/* OAuth2 로그인의 로직을 담당한다.
 * OAuth2UserService를 커스텀한 CustomOAuth2UserService이다.
 */
@Slf4j
@Service
